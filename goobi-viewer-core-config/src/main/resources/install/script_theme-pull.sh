...
#
# The script should return one of three return values:
#
# 0 - if the repository was successfully pulled
# 1 - if the pull command returned "Already up to date", i.e. no changes were detected to pull
# 2 - if an error occured. In this case an error description should be passed to the error output stream
#
